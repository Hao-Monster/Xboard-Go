...
credential or a pending password-recovery or registration-verification mail. The application intentionally
refuses to start if the key is missing or cannot authenticate a stored SMTP
credential; email-code registration and password recovery remain unavailable
without the key.
