...
credential or a pending password-recovery mail. The application intentionally
refuses to start if the key is missing or cannot authenticate a stored SMTP
credential; password recovery remains unavailable without the key.
