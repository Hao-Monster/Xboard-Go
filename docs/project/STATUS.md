...
Baseline: `M0` · as of 2026-09-03 · verification target `92bae89021d18ee0eff0dca8f0783b734a04850f`
...
| Verification | `current` | 45 |
| Verification | `historical` | 31 |
| Verification | `partial` | 2 |
| Verification | `none` | 2 |
| Migration | `current` | 41 |
| Migration | `historical` | 32 |
| Migration | `partial` | 1 |
| Migration | `not_assessed` | 1 |
| Migration | `not_applicable` | 5 |
| Acceptance | `accepted` | 45 |
| Acceptance | `pending` | 35 |
...
- Current-head verification: 45/80; accepted: 45/80. Historical evidence is not current acceptance.
...
Current-head verification is 45/80 and formal acceptance is 45/80. Release readiness still depends on the milestone gates above; M0 establishes the control plane, and M1–M4 close business decisions, migration/operations evidence, current candidate acceptance, and production readiness in that order.
