...
Baseline: `M0` · as of 2026-09-02 · verification target `c90e54a2f0013112a61899678ff4caade2e34443`
...
| Verification | `current` | 27 |
| Verification | `historical` | 49 |
| Verification | `partial` | 2 |
| Verification | `none` | 2 |
| Migration | `current` | 23 |
| Migration | `historical` | 50 |
| Migration | `partial` | 1 |
| Migration | `not_assessed` | 1 |
| Migration | `not_applicable` | 5 |
| Acceptance | `accepted` | 27 |
| Acceptance | `pending` | 53 |
...
- Current-head verification: 27/80; accepted: 27/80. Historical evidence is not current acceptance.
