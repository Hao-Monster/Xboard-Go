...
Baseline: `M0` · as of 2026-09-08 · verification target `48db5761879e68aa9fc50718c674365e726364ed`
...
| `FUNC-001` | M1 | done | [#114](https://github.com/Hao-Monster/Xboard-Go/issues/114) | 确定并实现原子佣金提现账本 |
| `FUNC-002` | M1 | done | [#115](https://github.com/Hao-Monster/Xboard-Go/issues/115) | 确定并实现用户停用、恢复与匿名化 |
| `FUNC-003` | M1 | done | [#145](https://github.com/Hao-Monster/Xboard-Go/issues/145) | 恢复管理员安全路径完整语义 |
| `OPS-001` | M2 | done | [#116](https://github.com/Hao-Monster/Xboard-Go/issues/116) | 确定并实施日志与统计迁移保留策略 |
| `OPS-002` | M2 | in_progress | [#117](https://github.com/Hao-Monster/Xboard-Go/issues/117) | 完成备份、异地副本和恢复演练 |
| `MIG-001` | M2 | in_progress | [#118](https://github.com/Hao-Monster/Xboard-Go/issues/118) | 完成代表性旧数据迁移、对账和回滚证据 |
