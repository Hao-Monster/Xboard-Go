...
function createAPI(): AdminAPI & { saveActivationSchedule: ReturnType<typeof vi.fn> } {
  ...
  return {
    ...
    resetAdminUserPassword: vi.fn(),
		...
		getAdminUserDeletionImpact: vi.fn(),
    ...
    listAdminCommissionWithdrawals: vi.fn(),
    getAdminCommissionWithdrawalAccount: vi.fn(),
    approveCommissionWithdrawal: vi.fn(),
    rejectCommissionWithdrawal: vi.fn(),
    payCommissionWithdrawal: vi.fn(),
