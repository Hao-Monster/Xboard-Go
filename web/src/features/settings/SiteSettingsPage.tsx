      ...
      <form className="form-stack site-settings-form" onSubmit={(event) => void save(event)}>
        ...
        <div className="site-settings-section-fields" style={{ display: showSite ? "block" : "none" }}>
          ...
          <div className="site-settings-url-grid">
            ...
            <label>用户条款(TOS)URL<input type="url" placeholder="请输入用户条款URL，末尾不要/" value={draft.tos_url} onChange={(event) => updateDraft("tos_url", event.target.value)} /></label>
          ...
          <fieldset className="settings-fieldset">
            ...
            <p className="small muted">当站点没有使用HTTPS，CDN或反代开启强制HTTPS时需要开启。</p>
            ...
            <p className="small muted" id="subscribe-url-help">用于订阅所使用，留空则为站点URL；每行一个地址，最多 32 个。</p>
          </fieldset>
          <div className="site-settings-url-grid">
          ...
          <p className="small muted">开启后任何人都将无法进行注册。</p>
          <fieldset className="settings-fieldset">
        ...
        <div className="security-settings-section-fields" style={{ display: showSecurity ? "block" : "none" }}>
          <fieldset className="settings-fieldset">
            <legend>访问安全</legend>
