...
import type { ClientCatalogEntry, ClientCatalogQR, KnowledgeArticle, KnowledgeLanguage, NoticePage, UserSession } from "../../lib/api";
...
export function UserPortal({ api, session, onSignedOut }: {
  ...
  const [page, setPage] = useState<"notices" | "knowledge" | "clients">("notices");
