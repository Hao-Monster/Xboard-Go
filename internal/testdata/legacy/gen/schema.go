...
CREATE TABLE v2_knowledge_attachment (
    id INTEGER PRIMARY KEY,
    uuid TEXT NOT NULL,
...
CREATE TABLE v2_knowledge_attachment_upload (
    id INTEGER PRIMARY KEY,
    uuid TEXT NOT NULL,
    uploader_user_id INTEGER NOT NULL,
...
CREATE TABLE v2_gift_card_usage (
    ...
    user_id INTEGER NOT NULL,
    invite_user_id INTEGER,
    rewards_given TEXT NOT NULL,
    invite_rewards TEXT,
    user_level_at_use INTEGER,
    plan_id_at_use INTEGER,
    multiplier_applied NUMERIC NOT NULL DEFAULT 1.00,
    ip_address TEXT,
    user_agent TEXT,
    notes TEXT,
    created_at INTEGER NOT NULL
