...
func TestRepresentativeLegacyMigrationDrill(t *testing.T) {
	...
	assertTargetCounts(t, targetPath, map[string]int{
		"users": 2, "knowledge": 1, "plans": 2, "access_tokens": 2, "invitation_codes": 2,
		"knowledge_attachments": 0, "knowledge_attachment_uploads": 0,
		"coupons": 2, "gift_card_templates": 1, "gift_card_codes": 1, "gift_card_usages": 1,
		"payments": 1, "orders": 2, "tickets": 2,
	...
	ordersBackup := filepath.Join(directory, "12-pre-orders.xbbackup")
	...
	assertTargetCounts(t, restoredPath, map[string]int{
		"users": 2, "knowledge": 1, "plans": 2, "coupons": 2,
		"knowledge_attachments": 0, "knowledge_attachment_uploads": 0,
		"gift_card_templates": 1, "gift_card_codes": 1, "gift_card_usages": 1,
		"payments": 1, "orders": 0, "nodes": 0, "legacy_migration_runs": 11,
	})
	...
	assertTargetCounts(t, restoredInitialPath, map[string]int{
		"users": 1, "knowledge": 0, "plans": 0, "access_tokens": 0, "invitation_codes": 0,
		"knowledge_attachments": 0, "knowledge_attachment_uploads": 0,
		"coupons": 0, "gift_card_templates": 0, "gift_card_codes": 0, "gift_card_usages": 0,
		"payments": 0, "orders": 0, "tickets": 0,
...
func assertRedacted(t *testing.T, output string) {
	...
	for _, forbidden := range []string{
		...
		"synthetic-ipn-secret", "synthetic-machine-token", "SYNTHETICGC000131", "$2y$10$",
	} {
