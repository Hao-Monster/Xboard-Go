...
func applySchemaV62UserLifecycle(ctx context.Context, tx *sql.Tx) error {
	...
	if _, err := tx.ExecContext(ctx, schemaV62UserLifecycle); err != nil {
		return err
	}
