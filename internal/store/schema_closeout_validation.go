...
// validateSchemaV61Objects ensures SQLite did not retain a weakened object
// definition from an earlier failed or manually altered migration.
func validateSchemaV61Objects(ctx context.Context, database schemaQueryer) error {
	return validateDeclaredSchemaObjects(ctx, database, schemaV60CommissionWithdrawals)
}
