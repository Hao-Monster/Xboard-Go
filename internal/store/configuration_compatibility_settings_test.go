...
func TestSchemaV54AddsConfigurationCompatibilityDefaultsAndConstraints(t *testing.T) {
	...
	if version != 62 || withdrawLimit != 10_000 || withdrawMethods != `["支付宝","USDT","Paypal"]` || sidebarStyle != "light" || headerStyle != "dark" {
...
func TestSchemaV54UpgradePreservesV53Rows(t *testing.T) {
	...
	if version != 62 || appName != "Preserved V53" || appRevision != 27 || themeRevision != 9 ||
