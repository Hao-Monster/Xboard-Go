...
func TestTrustedPluginAdministratorAPIAndPaymentProviderGate(t *testing.T) {
	...
	listed := admin.request(t, api, http.MethodGet, "/api/v1/admin/plugins", "")
	...
	updated := admin.request(t, api, http.MethodPatch, "/api/v1/admin/plugins/epay", string(body))
	...
	create := admin.request(t, api, http.MethodPost, "/api/v1/admin/payments", `{
	...
	stale := admin.request(t, api, http.MethodPatch, "/api/v1/admin/plugins/epay", string(body))
	...
	unknown := admin.request(t, api, http.MethodPatch, "/api/v1/admin/plugins/shell", `{"revision":1,"enabled":true,"config":{}}`)
