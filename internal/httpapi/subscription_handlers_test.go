...
func TestClientSubscriptionMatchesLegacyTokenMethodEligibilityAndRouteContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "valid HEAD", method: http.MethodHead, path: "/api/v1/client/subscribe?token=" + valid.SubscriptionToken, wantStatus: http.StatusMethodNotAllowed, wantType: "text/plain; charset=utf-8", wantCache: "no-store, private"},
		...
		{name: "prefetch", method: http.MethodGet, path: "/api/v1/client/subscribe?token=" + valid.SubscriptionToken, headers: map[string]string{"Purpose": "prefetch"}, wantStatus: http.StatusTooEarly, wantType: "text/plain; charset=utf-8", wantCache: "no-store, private"},
		{name: "sec prefetch", method: http.MethodGet, path: "/api/v1/client/subscribe?token=" + valid.SubscriptionToken, headers: map[string]string{"Sec-Purpose": "prefetch"}, wantStatus: http.StatusTooEarly, wantType: "text/plain; charset=utf-8", wantCache: "no-store, private"},
