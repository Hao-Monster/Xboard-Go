...
func TestGiftCardModernAPIsCreateGenerateCheckRedeemAndHistory(t *testing.T) {
	...
	created := admin.request(t, api, http.MethodPost, "/api/v1/admin/gift-card/templates", `{
	...
	updatedTemplate := admin.request(t, api, http.MethodPut, fmt.Sprintf("/api/v1/admin/gift-card/templates/%d", templatePayload.Data.ID), `{"name":"API 礼品卡（已更新）","sort":2}`)
	...
	templates := admin.request(t, api, http.MethodGet, "/api/v1/admin/gift-card/templates?page=1&page_size=20&type=1&status=true", "")
	...
	generated := admin.request(t, api, http.MethodPost, "/api/v1/admin/gift-card/codes/generate",
	...
	toggled := admin.request(t, api, http.MethodPost, fmt.Sprintf("/api/v1/admin/gift-card/codes/%d/toggle", codePayload.Data[1].ID), "")
	...
	deletedUnusedCode := admin.request(t, api, http.MethodDelete, fmt.Sprintf("/api/v1/admin/gift-card/codes/%d", codePayload.Data[1].ID), "")
	...
	updated := admin.request(t, api, http.MethodPatch, fmt.Sprintf("/api/v1/admin/gift-card/codes/%d", codePayload.Data[0].ID), `{"expires_at":1800000000}`)
	...
	cleared := admin.request(t, api, http.MethodPatch, fmt.Sprintf("/api/v1/admin/gift-card/codes/%d", codePayload.Data[0].ID), `{"expires_at":null}`)
	...
	usageList := admin.request(t, api, http.MethodGet, fmt.Sprintf("/api/v1/admin/gift-card/usages?page=1&page_size=20&user_id=%d", user.id), "")
	...
	statistics := admin.request(t, api, http.MethodGet, "/api/v1/admin/gift-card/statistics", "")
	...
	listed := admin.request(t, api, http.MethodGet, "/api/v1/admin/gift-card/codes?page=1&page_size=20", "")
	...
	deleteUsedCode := admin.request(t, api, http.MethodDelete, fmt.Sprintf("/api/v1/admin/gift-card/codes/%d", codePayload.Data[0].ID), "")
	...
	deleteReferencedTemplate := admin.request(t, api, http.MethodDelete, fmt.Sprintf("/api/v1/admin/gift-card/templates/%d", templatePayload.Data.ID), "")
	...
	unusedTemplate := admin.request(t, api, http.MethodPost, "/api/v1/admin/gift-card/templates", `{"name":"Unused API gift","type":1,"status":true,"rewards":{"balance":1}}`)
	...
	deletedTemplate := admin.request(t, api, http.MethodDelete, fmt.Sprintf("/api/v1/admin/gift-card/templates/%d", unusedPayload.Data.ID), "")
...
func TestGiftCardLegacyContractsAndAdminPermission(t *testing.T) {
	...
	forbidden := userClient.request(t, api, http.MethodPost, "/api/v1/admin/gift-card/templates", `{"name":"no","type":1,"rewards":{"balance":1}}`)
...
func TestGiftCardCSVGenerationAndExportIncludeSafeTemplateName(t *testing.T) {
	...
	downloaded := admin.request(t, api, http.MethodPost, "/api/v1/admin/gift-card/codes/generate",
	...
	exported := admin.request(t, api, http.MethodGet, "/api/v1/admin/gift-card/codes/export?batch_no="+codePayload.Data[0].BatchNo, "")
